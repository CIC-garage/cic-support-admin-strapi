...
export interface ApiMadinetmasrMadinetmasr extends Struct.CollectionTypeSchema {
  ...
  info: {
    displayName: 'madinetmasr';
    pluralName: 'madinetmasrs';
    singularName: 'madinetmasr';
  };
  options: {
...
export interface ApiTmgTmg extends Struct.CollectionTypeSchema {
  collectionName: 'tmgs';
  info: {
    displayName: 'tmg';
    pluralName: 'tmgs';
  ...
  attributes: {
    ...
    desc: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::tmg.tmg'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    stage: Schema.Attribute.Enumeration<['open', 'inprogress', 'closed']>;
    title: Schema.Attribute.String;
